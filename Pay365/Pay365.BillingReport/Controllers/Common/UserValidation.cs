    ...
    public class UserValidation : SSOInfo
    {
        ...
        public bool CheckPermissionUser(string Action, int UserId, bool IsAdmin = false)
        {
            ...
            try
            {
                ...
                var m_function = DataAccess.ReportAPI.Factory.AbstractDAOFactory.Instance().CreateFunctionDAO().
                ...
                {
                    permission = DataAccess.ReportAPI.Factory.AbstractDAOFactory.Instance().CreateUserRoleDAO().
            ...
            {
                Pay365.Utils.NLogLogger.LogInfo(ex.ToString());
                return false;
            }
        }
