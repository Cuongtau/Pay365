(function () {
    ...
    a = function () {
        function a(a, b) {
            var c;
            c = this, this.opts = $.extend({}, this.defaults, b), this.$el = $(a), this.countdowns = [], this.prepareHTML(), this.countdownInit(this.$el), this.$el.on("countdown:reset", function () {
                return c.reset(c.$el)
            })
        }
        return a.prototype.version = "1.4.3", a.prototype.defaults = {
            dayText: "day ",
            days2Text: "days ",
            daysText: "days ",
            hourText: "hour ",
            ...
            var d, e, f, g, h;
            return h = this, g = this.fixTime(c % 60), c = Math.floor(c / 60), f = this.fixTime(c % 60), c = Math.floor(c / 60), e = this.fixTime(c % 24), c = Math.floor(c / 24), d = c, h.opts.oneDayClass && a && b.addClass(h.opts.oneDayClass), h.opts.displayDays && (0 === d && h.opts.displayZeroDays ? (b.find("." + h.opts.boxDaysClass).html(d), b.find("." + h.opts.boxDaysTextClass).html(this.formatText(d, "day"))) : d > 0 && (b.find("." + h.opts.boxDaysClass).html(d), b.find("." + h.opts.boxDaysTextClass).html(this.formatText(d, "day")))), b.find("." + h.opts.boxHoursClass).html(e), b.find("." + h.opts.boxHoursTextClass).html(this.formatText(e, "hour")), b.find("." + h.opts.boxMinClass).html(f), b.find("." + h.opts.boxSecClass).html(g)
