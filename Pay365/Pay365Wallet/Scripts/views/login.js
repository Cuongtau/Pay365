            ...
            if (typeof data === "object") {
                ...
                //captcha ko ddungs
                    ...
                    if (utils.getCurrentLanguage() === 'en') {
                        ...
                        var contentTempLock = '<div class="strike"><div id="timer_countdown" class="time">' + (minutes + ':' + (seconds < 10 ? ('0' + seconds) : seconds)) + '</div><div class="strike-description"><p>Tài khoản của bạn bị khóa 5 phút do nhập sai quá 5 lần. Vui lòng chờ hết thời gian khóa và thực hiện đăng nhập lại.</p><strong class="secondary">Liên hệ CSKH 093-4676-505</strong></div></div>';
                        $('#content_login').html(contentTempLock);
