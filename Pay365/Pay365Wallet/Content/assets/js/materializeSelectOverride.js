      ...
      var appendOptionWithIcon = function(select, option, type) {
        ...
        if (!!icon_url) {
          ...
          if (type === 'multiple') {
            ...
            options.append($('<li class="' + disabledClass + '"' + placeholderString + '><img src="' + icon_url + '"' + classString + '><span>' + optionContent + '</span></li>'));
          }
          return true;
        }
        ...
        // Check for multiple type.
        if (type === 'multiple') {
          options.append($('<li class="' + disabledClass + '"' + placeholderString + '><span><input type="checkbox"' + disabledClass + '/><label></label>' + optionContent + '</span></li>'));
        } else {
          options.append($('<li class="' + disabledClass + '"' + placeholderString + '><span>' + optionContent + '</span></li>'));
        }
      };
        ...
        $(this).click(function (e) {
          ...
          if (!$(this).hasClass('disabled') && !$(this).hasClass('optgroup')) {
            ...
            if (multiple) {
              ...
              var findIdx = newValue.toLowerCase().indexOf(" vnđ");
              if (findIdx >= 0)
              {
                  newValue = newValue.substring(0, findIdx);
              }
