...
namespace DataAccess.ReportAPI.DAOImpl
{
    public class FunctionsDAOImpl : IFucntionsDAO
    {
        ...
        public Functions GetFunctionByFunctionID(int functionId)
        {
            try
            {
                return new DBHelper(Config.AdminReportConnectionString).GetInstanceSP<Functions>("SP_Functions_GetByFunctionID",
        ...
        public Functions GetFunctionByActionName(string ActionName)
        {
            try
            {
                return new DBHelper(Config.AdminReportConnectionString).GetInstanceSP<Functions>("SP_Functions_GetByActionName",
        ...
        public List<Functions> GetListFunctionByUserID(int userId, int grant)
        {
            try
            {
                ...
                return new DBHelper(Config.AdminReportConnectionString).GetListSP<Functions>("SP_Function_GetByUserID", pars);
            }
            catch (Exception ex)
            {
                NLogLogger.LogInfo(ex.ToString());
        ...
        public List<Functions> GetListFunctions(string Keyword, int isAcitve, int pageNumber, int pageSize, ref int TotalRecord)
        {
            try
            {
                ...
                var list = new DBHelper(Config.AdminReportConnectionString).GetListSP<Functions>("SP_Functions_GetPage", pars);
        ...
        public List<Functions> GetListFunctionsByFather(int FatherID)
        {
            try
            {
                var list = new DBHelper(Config.AdminReportConnectionString).GetListSP<Functions>("SP_Functions_GetParent",
        ...
        public int InsertUpdateFunction(Functions functions)
        {
            try
            {
                ...
                new DBHelper(Config.AdminReportConnectionString).ExecuteNonQuerySP("SP_Functions_Update", pars);
        ...
        public int UpdateOrder(int FunctionID, int ParentID, int Order)
        {
            try
            {
                ...
                new DBHelper(Config.AdminReportConnectionString).ExecuteNonQuerySP("SP_Functions_UpdateOrder", pars);
                return Convert.ToInt32(pars[9].Value);
            }
            catch (Exception ex)
            {
        ...
        public int DelleteFunction(int functionId)
        {
            try
            {
                ...
                new DBHelper(Config.AdminReportConnectionString).ExecuteNonQuerySP("SP_Functions_Delete", pars);
        ...
        public List<Functions> SelectAllFunctionID(int fatherID, string name, int isactive, int isdisplay)
        {
            try
            {
                ...
                var result = new DBHelper(Config.AdminReportConnectionString).GetListSP<Functions>("SP_Functions_SelectByCondition", pars);
                return result;
            }
            catch (Exception ex)
            {
