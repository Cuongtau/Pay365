...
using Pay365.Pay365.Localization;
using Pay365.Pay365.Localization.Dto;
using Pay365.Pay365.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace Pay365.Pay365.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = Pay365Consts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
            ...
            var newValue = Resolve<ILocalizationManager>()
                .GetString(
                    Pay365Consts.LocalizationSourceName,
                    "Save",
