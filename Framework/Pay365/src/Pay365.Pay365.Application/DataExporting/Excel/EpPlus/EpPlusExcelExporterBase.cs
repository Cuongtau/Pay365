...
using Pay365.Pay365.Net.MimeTypes;
using OfficeOpenXml;

namespace Pay365.Pay365.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : Pay365ServiceBase, ITransientDependency
    {
