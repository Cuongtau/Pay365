...
using Pay365.Pay365.Authorization.Roles.Dto;

namespace Pay365.Pay365.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : Pay365AppServiceBase, IRoleAppService
    {
