...
using Pay365.Pay365.Authorization.Impersonation;
using Pay365.Pay365.Authorization.Roles;
using Pay365.Pay365.Authorization.Users;
using Pay365.Pay365.Configuration;
using Pay365.Pay365.Debugging;
using Pay365.Pay365.MultiTenancy;
using Pay365.Pay365.Notifications;
using Pay365.Pay365.Web.Controllers.Results;
using Pay365.Pay365.Web.Models.Account;
using Pay365.Pay365.Web.MultiTenancy;
using Recaptcha.Web;
using Recaptcha.Web.Mvc;
using Newtonsoft.Json;
using Pay365.Pay365.Security;
using Pay365.Pay365.Web.Auth;
using Pay365.Pay365.Web.Models.Layout;

namespace Pay365.Pay365.Web.Controllers
{
    public class AccountController : Pay365ControllerBase
    {
