...
namespace Pay365.Pay365
{
    ...
    public class Pay365CoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.Localization.Sources.Add(
                new DictionaryBasedLocalizationSource(
                    ...
                    new XmlEmbeddedFileLocalizationDictionaryProvider(
                        ...
                        "Pay365.Pay365.Localization.Pay365"
                        )
                    )
                );
            ...
            Configuration.MultiTenancy.IsEnabled = Pay365Consts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
             {
                Configuration.IocManager.IocContainer.Register(
                    ...
                    .ImplementedBy<Pay365SmtpEmailSenderConfiguration>()
                    .LifestyleTransient()
                );
            });
